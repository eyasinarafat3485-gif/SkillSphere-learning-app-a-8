    ...
    <footer className="bg-[#485966] text-gray-400 py-10 border-t border-red-900/30">
      <div className="max-w-7xl mx-auto px-5 md:px-15 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <h3 className="text-orange-500 text-lg font-semibold uppercase tracking-widest">Contact Info</h3>
        ...
        <div className="flex flex-col items-start md:items-center space-y-4">
          <h3 className="text-orange-500 text-lg font-semibold uppercase tracking-widest">Social Links</h3>
          <div className="flex gap-6 text-2xl">
            <Link href="/" className="text-gray-300  hover:text-orange-500 transition-all duration-300 transform hover:-translate-y-1"><FaFacebook /></Link>
            <Link href="/" className=" text-gray-300 hover:text-orange-400 transition-all duration-300 transform hover:-translate-y-1"><FaTwitter /></Link>
            <Link href="/" className="text-gray-300 hover:text-orange-600 transition-all duration-300 transform hover:-translate-y-1"><FaLinkedin /></Link>
        ...
        <div className="md:text-right space-y-4">
          <h3 className="text-orange-500 text-lg font-semibold uppercase tracking-widest">Legal</h3>
          <ul className="space-y-2 text-sm">
            <li>
      ...
      <div className="max-w-7xl mx-auto pt-4 mt-5  border-t border-red-900/20 text-center text-[10px] uppercase tracking-[0.2em] text-gray-500">
        <p className='text-gray-300'>&copy; {new Date().getFullYear()} <span className="text-orange-500 ">SkillSphere</span>. All rights reserved.</p>
      </div>
    </footer>
  );
};
